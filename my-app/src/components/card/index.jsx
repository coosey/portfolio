  ...
  return (
    <section className="mx-auto p-6 grid gap-4 lg:w-[80%] sm:w-[95%]">
      <div className="col-span-1 flex flex-col bg-white shadow-xl rounded-lg border-2 p-4">        
        ...
        <div className="my-4 w-fit flex flex-wrap items-center font-normal hover:text-blue-400 hover:underline underline-offset-2">
        ...
        <div className="flex flex-row flex-wrap gap-2">
          {props?.technology?.map?.((name) => (
            <div className="flex justify-start md:mb-2 text-start">
              <div className="inline-block bg-neutral-200 my-2 pb-1.5 px-4 pt-1.5 rounded-full text-xs">
                {name}
              </div>
            </div>
          ))}
